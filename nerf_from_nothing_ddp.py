...
# -*- coding: utf-8 -*-
"""NeRF From Nothing_modified

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/10T_EM7D7TRYp3TY3V0YFOtBD4Heyuzk4
...
# Gather as torch tensors
  ...
  for i in trange(n_iters):
    ...
    if one_image_per_step:
        ...
        # if i == 0:
        #   print("rays_o_shape:", rays_o.shape)
        #   print("rays_d_shape:", rays_d.shape)

        start_heights = list(range(0, rays_o.shape[0], int(rays_o.shape[0]/(args.world_size))))
        start_heights.append(rays_o.shape[0])
        #print(start_heights)
        #print(rays_o.type)
        rays_o_ddp = rays_o[start_heights[rank]: start_heights[rank+1]]
        rays_d_ddp = rays_d[start_heights[rank]: start_heights[rank+1]]


        # if i == 0:
        #   print("rays_o_ddp_shape:", rays_o_ddp.shape, "rank", rank)
        #   print("rays_d_ddp_shape:", rays_d_ddp.shape, "rank", rank)
    else:
